...
const Currencies = ({
  ...
  const currencySymbol = marketCap
    .toLocaleString("en-US", { style: "currency", currency: `${vsCurrency}` })
    .replace(/,*[0-9]+./g, "");
      ...
      >
        ...
        <Box sx={{ my: "auto" }}>
          ...
          <Typography
            component={"p"}
            fontSize={".7rem"}
            sx={{ lineHeight: 1.6, color: selectedCoinPricesStyle() }}
          >
            {currencySymbol}
